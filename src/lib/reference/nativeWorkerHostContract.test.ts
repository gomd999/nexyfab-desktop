...
const healthy: NativeWorkerHealth = { schema: 'nexyfab.native-worker-health.v1', workerKind: 'solidworks-native', worker: { name: 'sw-worker', version: '1', cadSystem: 'SOLIDWORKS 2026' }, host: { os: 'windows', architecture: 'x64' }, license: { status: 'valid' }, capabilities: { exactGeometry: true, nativeHierarchy: true, nativeConstraints: true, nativeParameters: true }, ready: true };

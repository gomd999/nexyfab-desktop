...
export const PLAN_MONTHLY_LIMITS: Record<string, Record<string, number>> = {
  free:       { analyze_step: 5,  rfq: 3,  shape_chat: 30, ai_advisor: 5,  supplier_match: -2, cam_export: -2, dfm_insights: 5,  process_router: 5,  ai_supplier_match: 3,  cost_copilot: 5,  rfq_writer: 5,  cert_filter: 10, rfq_responder: 5,  quote_negotiator: 3,  order_priority: -2, change_detector: -2, capacity_match: -2, quote_accuracy: -2, brep_step_import: 40, openscad_render: 80, scad_agent: -2, sim_run: -2, image_intent: -2, reverse_engineer: -2, quote_request: 20 },

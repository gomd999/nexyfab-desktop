...
export const PLAN_MONTHLY_LIMITS: Record<string, Record<string, number>> = {
  free:       { analyze_step: 5,  rfq: 3,  shape_chat: 30, ai_advisor: 5,  supplier_match: -2, cam_export: -2, dfm_insights: 5,  process_router: 5,  ai_supplier_match: 3,  cost_copilot: 5,  rfq_writer: 5,  cert_filter: 10, rfq_responder: 5,  quote_negotiator: 3,  order_priority: -2, change_detector: -2, capacity_match: -2, quote_accuracy: -2, brep_step_import: 40, openscad_render: 80, scad_agent: -2, sim_run: -2 },
  pro:        { analyze_step: -1, rfq: -1, shape_chat: -1, ai_advisor: -1, supplier_match: -1, cam_export: -1, dfm_insights: -1, process_router: -1, ai_supplier_match: -1, cost_copilot: -1, rfq_writer: -1, cert_filter: -1, rfq_responder: -1, quote_negotiator: -1, order_priority: -1, change_detector: -1, capacity_match: -1, quote_accuracy: -1, brep_step_import: -1, openscad_render: -1, scad_agent: 50, sim_run: 20 },
  team:       { analyze_step: -1, rfq: -1, shape_chat: -1, ai_advisor: -1, supplier_match: -1, cam_export: -1, dfm_insights: -1, process_router: -1, ai_supplier_match: -1, cost_copilot: -1, rfq_writer: -1, cert_filter: -1, rfq_responder: -1, quote_negotiator: -1, order_priority: -1, change_detector: -1, capacity_match: -1, quote_accuracy: -1, brep_step_import: -1, openscad_render: -1, scad_agent: 200, sim_run: 100 },
  enterprise: { analyze_step: -1, rfq: -1, shape_chat: -1, ai_advisor: -1, supplier_match: -1, cam_export: -1, dfm_insights: -1, process_router: -1, ai_supplier_match: -1, cost_copilot: -1, rfq_writer: -1, cert_filter: -1, rfq_responder: -1, quote_negotiator: -1, order_priority: -1, change_detector: -1, capacity_match: -1, quote_accuracy: -1, brep_step_import: -1, openscad_render: -1, scad_agent: -1, sim_run: -1 },
};

...
describe('AI Design Precision verification receipt', () => {
  ...
  it('rejects tampering, stale revisions, and incomplete PASS scope results', () => {
    ...
    const incomplete = issueAiDesignPrecisionVerificationReceipt({
      receiptId: 'receipt-3', request, status: 'PASS', keyId: 'precision-key-1',
      issuedAt: '2026-08-24T00:10:00.000Z', expiresAt: '2026-08-24T01:00:00.000Z',
      scopeResults: [{ kind: 'interface', id: 'interface-a-b', status: 'PASS', exactArtifactDigest: null, codes: [] }],
    }, secret);

...
export const CODEGEN_MODELS: CodegenModel[] = [
  ...
  { id: 'qwen-max',          label: 'Qwen3.7 Max',        provider: 'qwen',       model: 'qwen3.7-max',      note: 'DashScope · 무료' },
  { id: 'deepseek-v4-pro',   label: 'DeepSeek V4 Pro',    provider: 'qwen',       model: 'deepseek-v4-pro',  note: 'DashScope' },

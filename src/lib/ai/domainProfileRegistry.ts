...
export const DOMAIN_PROFILES = {
  mechanical: {
    ...
    manualTools: { guided: ['dimension', 'move-part', 'replace-component', 'lock-parameter'], expert: ['sketch', 'feature-tree', 'mate', 'surface', 'gdt', 'cam'] },
  ...
  building: {
    ...
    manualTools: { guided: ['move-wall', 'resize-space', 'set-level', 'add-opening'], expert: ['grid', 'host-edit', 'layer-compose', 'section-detail', 'ifc-properties'] },
  ...
  civil: {
    ...
    manualTools: { guided: ['edit-alignment', 'edit-profile', 'set-design-elevation', 'resolve-drainage-low-point'], expert: ['survey-adjust', 'surface-breakline', 'corridor-target', 'cross-section', 'drainage-network', 'stage-model'] },
  ...
  landscape: {
    ...
    manualTools: { guided: ['paint-planting-zone', 'set-spacing', 'edit-grade', 'split-irrigation-zone'], expert: ['terrain-modifier', 'plant-data', 'soil-volume', 'hardscape-joint', 'hydraulic-network'] },
  ...
  interior: {
    ...
    manualTools: { guided: ['move-furniture', 'change-finish', 'set-ceiling-height', 'check-door-clearance'], expert: ['space-boundary', 'millwork', 'reflected-ceiling', 'lighting-layout', 'finish-build-up'] },

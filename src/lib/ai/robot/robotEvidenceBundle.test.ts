...
describe('robot evidence bundle trust boundary', () => {
  it('accepts the current immutable demonstrator report/program pair without promoting it', async () => {
    ...
    expect(result).toMatchObject({ editableParts: 25, mates: 60, rankDoF: 6, allowedDoF: 6, flaggedInterferences: 0, collisionFrames: 0, motionFrames: 156, checkedMotionFrames: 156, motionConverged: true, coordinatedMotionFrames: 49, checkedCoordinatedMotionFrames: 49, coordinatedCollisionFrames: 0, coordinatedMotionConverged: true, effectiveReleaseReady: false });

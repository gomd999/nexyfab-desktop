...
const post = { schema: 'nexyfab.robot-post-integration-evidence.v1', postIntegrationStatus: 'passed', programHash, targetHash: 'b'.repeat(64), catalogManifestSha256: 'c'.repeat(64), releaseReady: false, errors: [], counts: { selectedOccurrences: 18, motionFrames: 156, checkedMotionFrames: 156, collisionFrames: 0, coordinatedMotionFrames: 49, checkedCoordinatedMotionFrames: 49, coordinatedCollisionFrames: 0, preciseInterferences: 0 } };

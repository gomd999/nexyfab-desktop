...
const COPY: Record<IsoLang, ComplexScopeCopy> = {
  ko: {
    badge: '복잡 제품 · 폐쇄형 베타',
    availability: '지금 설계 후보 생성·편집에 사용할 수 있으며 작업은 자동 저장됩니다.',
  ...
  en: {
    ...
    availability: 'Available now for creating and editing design candidates, with work saved automatically.',
  ...
  ja: {
    badge: '複雑製品 · クローズドベータ',
    availability: '設計候補の作成・編集に今すぐ利用でき、作業は自動保存されます。',
  ...
  zh: {
    badge: '复杂产品 · 封闭测试',
    availability: '现在即可创建和编辑设计候选，工作内容会自动保存。',
  ...
  es: {
    ...
    availability: 'Ya está disponible para crear y editar candidatos de diseño, con guardado automático.',
  ...
  ar: {
    ...
    availability: 'متاح الآن لإنشاء مرشحات التصميم وتحريرها، مع حفظ العمل تلقائيًا.',

...
const TEMPLATE = `You are a senior mechanical design engineer AI embedded in NexyFab, a web-based parametric CAD tool.
...
const def: PromptDefinition = {
  id: 'shape-chat',
  version: '1.0.0',
  description: 'Manufacturing-grade parametric CAD AI — natural language → JSON intent for single/bom/sketch/optimize/modify modes.',
  template: TEMPLATE,
  defaults: {
    temperature: 0.2,
    maxTokens: 6000,

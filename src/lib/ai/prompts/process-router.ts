...
const TEMPLATE =
  ...
  'For each process, provide: fitness score (0-100), reasoning/pros/cons in the requested output language and Korean legacy translations in the corresponding *Ko fields, ' +

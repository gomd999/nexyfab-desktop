...
export type CommercialPersistenceFixture = {
  ...
  trustedWorkers: Record<string, { workerIdentity: string; publicKeyPem: string; fingerprintSha256: string; nativeExecutableSha256: string; nativeInvocationSha256: string }>;
...
export function makeCommercialPersistenceFixture(): CommercialPersistenceFixture {
  ...
  return { db, artifactStore, workerReceipt: workerReceipt, parserReceipt: parser, job, journal, workerMetadata: metadata, trustedWorkers: { 'worker-1': { workerIdentity: 'worker-1', publicKeyPem: worker.publicKeyPem, fingerprintSha256: worker.fingerprint, nativeExecutableSha256: workerReceipt.nativeExecutableSha256!, nativeInvocationSha256: workerReceipt.nativeInvocationSha256! } }, trustedParser: { parserIdentity: 'occt-parser', publicKeyPem: parserPublicKeyPem, fingerprintSha256: parserFingerprint }, expected, snapshotKeys: [] };
}

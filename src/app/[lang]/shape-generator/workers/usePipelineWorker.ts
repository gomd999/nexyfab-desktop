...
export function usePipelineWorker() {
  ...
  useEffect(() => {
    try {
      ...
      // Worker creation fails in SSR — will fall back to synchronous execution.
  ...
  /** Terminate in-flight work and reset state. */
  ...
  return { runPipeline, loading, cancel };
}

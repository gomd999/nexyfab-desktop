...
const dict = {
  ...
  en: {
    ...
    actSplitView: 'Toggle split view (notes / spec)',
  ...
  es: {
    ...
    actSplitView: 'Alternar vista dividida (notas / especif.)',
  ...
  ar: {
    ...
    actSplitView: 'تبديل العرض المنقسم (ملاحظات / مواصفات)',
  ...
  const categories: ShortcutCategory[] = [
    {
      ...
      items: [
        ...
        // Round 36: surface the split-screen toggle from Round 33-35.
        { id: 'split_view',  keys: ['Ctrl+\\'],         label: t.actSplitView ?? 'Toggle split view (notes / spec)' },
      ],
    },
    {

...
const L: Record<string, Record<string, string>> = {
  ko: { title: '디자인을 시작해보세요', desc: '스케치를 그리거나, 기본 형상을 선택하거나, 파일을 불러오세요', sketch: '스케치 시작', import: '파일 불러오기', importing: '불러오는 중...', pickShape: '또는 기본 형상 선택', tutorial: '튜토리얼 시작하기', box: '박스', cylinder: '실린더', sphere: '구', gear: '기어' },
  en: { title: 'Start Your Design', desc: 'Draw a sketch, pick a base shape, or import a file', sketch: 'Sketch', import: 'Import', importing: 'Importing...', pickShape: 'Or pick a shape', tutorial: 'Start Tutorial', box: 'Box', cylinder: 'Cylinder', sphere: 'Sphere', gear: 'Gear' },
  ja: { title: 'デザインを始めましょう', desc: 'スケッチを描くか、基本形状を選択するか、ファイルをインポートしてください', sketch: 'スケッチ開始', import: 'インポート', importing: 'インポート中...', pickShape: 'または基本形状を選択', tutorial: 'チュートリアル開始', box: 'ボックス', cylinder: 'シリンダー', sphere: '球', gear: 'ギア' },
  cn: { title: '开始您的设计', desc: '绘制草图、选择基本形状或导入文件', sketch: '开始草图', import: '导入', importing: '导入中...', pickShape: '或选择基本形状', tutorial: '开始教程', box: '长方体', cylinder: '圆柱体', sphere: '球体', gear: '齿轮' },
  es: { title: 'Comience su Diseño', desc: 'Dibuje un boceto, elija una forma base o importe un archivo', sketch: 'Boceto', import: 'Importar', importing: 'Importando...', pickShape: 'O elija una forma', tutorial: 'Iniciar Tutorial', box: 'Caja', cylinder: 'Cilindro', sphere: 'Esfera', gear: 'Engranaje' },
  ar: { title: 'ابدأ تصميمك', desc: 'ارسم مخططًا أو اختر شكلاً أساسيًا أو استورد ملفًا', sketch: 'بدء الرسم', import: 'استيراد', importing: 'جاري الاستيراد...', pickShape: 'أو اختر شكلاً', tutorial: 'بدء الدليل التعليمي', box: 'صندوق', cylinder: 'أسطوانة', sphere: 'كرة', gear: 'ترس' },
};

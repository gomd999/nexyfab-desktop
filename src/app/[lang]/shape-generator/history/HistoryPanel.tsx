...
const dict = {
  ko: {
    title: '명령 히스토리', undo: '실행 취소 (Ctrl+Z)', redo: '다시 실행 (Ctrl+Y)',
    current: '현재', step: '단계', stepPlural: '단계', redoable: '재실행 가능',
    none: '히스토리 없음', clear: '히스토리 지우기',
  },
  en: {
    title: 'Command History', undo: 'Undo (Ctrl+Z)', redo: 'Redo (Ctrl+Y)',
    current: 'Current', step: 'step', stepPlural: 'steps', redoable: 'redoable',
    none: 'No history', clear: 'Clear History',
  },
  ja: {
    title: 'コマンド履歴', undo: '元に戻す (Ctrl+Z)', redo: 'やり直し (Ctrl+Y)',
    current: '現在', step: 'ステップ', stepPlural: 'ステップ', redoable: 'やり直し可能',
    none: '履歴なし', clear: '履歴をクリア',
  },
  zh: {
    title: '命令历史', undo: '撤销 (Ctrl+Z)', redo: '重做 (Ctrl+Y)',
    current: '当前', step: '步', stepPlural: '步', redoable: '可重做',
    none: '无历史', clear: '清除历史',
  },
  es: {
    title: 'Historial de Comandos', undo: 'Deshacer (Ctrl+Z)', redo: 'Rehacer (Ctrl+Y)',
    current: 'Actual', step: 'paso', stepPlural: 'pasos', redoable: 'rehacer',
    none: 'Sin historial', clear: 'Limpiar Historial',
  },
  ar: {
    title: 'سجل الأوامر', undo: 'تراجع (Ctrl+Z)', redo: 'إعادة (Ctrl+Y)',
    current: 'الحالي', step: 'خطوة', stepPlural: 'خطوات', redoable: 'قابل للإعادة',
    none: 'لا يوجد سجل', clear: 'مسح السجل',
  },
};
    ...
    >
      ...
      >
        ...
        <span style={{ color: C.textDim, fontSize: 11, marginLeft: 8 }}>
          {history.past.length} {history.past.length !== 1 ? t.stepPlural : t.step}
          {history.future.length > 0 && ` · ${history.future.length} ${t.redoable}`}
        </span>
      </div>

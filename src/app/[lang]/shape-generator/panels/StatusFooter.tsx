    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          borderRadius: 6,
          // Light/dark theme-aware tokens. Hardcoded dark RGBs made the
          // pill an unreadable black block under the light theme.
          border: `1px solid ${occtMode ? 'var(--nx-ok)' : 'var(--nx-border-strong)'}`,
          background: occtMode ? 'rgba(16,185,129,0.15)' : 'var(--nx-panel)',

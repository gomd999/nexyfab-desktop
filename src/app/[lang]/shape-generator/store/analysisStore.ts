...
import type { DraftAnalysisResult } from '../analysis/draftAnalysis'
...
interface AnalysisActions {
  ...
  setDraftResult: (result: DraftAnalysisResult | null) => void
  setDraftMinDeg: (deg: number) => void

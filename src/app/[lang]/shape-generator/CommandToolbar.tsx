...
export default function CommandToolbar(props: CommandToolbarProps) {
  ...
  const featureTools: (ToolBtn | 'sep')[] = [
    { id: 'ft-extrude', icon: '⬆', label: tt.ftExtrude, title: sketchRibbonFullTitle(lang, 'ft-extrude', tt.ftExtrude), action: () => onAddFeature('boolean'), active: false },
    { id: 'ft-extcut', icon: '⬇', label: tt.ftExtCut, title: sketchRibbonFullTitle(lang, 'ft-extcut', tt.ftExtCut), action: () => onExtrudeCut?.() },
    { id: 'ft-revolve', icon: '🔄', label: tt.ftRevolve, title: sketchRibbonFullTitle(lang, 'ft-revolve', tt.ftRevolve), action: () => onAddFeature('revolve') },
    { id: 'ft-sweep', icon: '〰️', label: tt.ftSweep, title: sketchRibbonFullTitle(lang, 'ft-sweep', tt.ftSweep), action: () => onAddFeature('sweep') },
    { id: 'ft-loft', icon: '◈', label: tt.ftLoft, title: sketchRibbonFullTitle(lang, 'ft-loft', tt.ftLoft), action: () => onAddFeature('loft') },
    'sep',
    { id: 'ft-fillet', icon: '◠', label: tt.ftFillet, title: sketchRibbonFullTitle(lang, 'ft-fillet', tt.ftFillet), action: () => onAddFeature('fillet') },
    { id: 'ft-chamfer', icon: '⬠', label: tt.ftChamfer, title: sketchRibbonFullTitle(lang, 'ft-chamfer', tt.ftChamfer), action: () => onAddFeature('chamfer') },
    { id: 'ft-shell', icon: '▢', label: tt.ftShell, title: sketchRibbonFullTitle(lang, 'ft-shell', tt.ftShell), action: () => onAddFeature('shell') },
    { id: 'ft-draft', icon: '📐', label: tt.ftDraft, title: sketchRibbonFullTitle(lang, 'ft-draft', tt.ftDraft), action: () => onAddFeature('draft') },
    'sep',
    { id: 'ft-hole', icon: '◎', label: tt.ftHoleWizard, title: sketchRibbonFullTitle(lang, 'ft-hole', tt.ftHoleWizard), action: () => { if (onHoleWizard) onHoleWizard(); else onAddFeature('hole'); } },
    { id: 'ft-thread', icon: '🔩', label: tt.ftThread, title: sketchRibbonFullTitle(lang, 'ft-thread', tt.ftThread), action: () => onAddFeature('thread') },
    { id: 'ft-boolean', icon: '⊕', label: tt.ftBoolean, action: () => onAddFeature('boolean') },
    'sep',
    { id: 'ft-pattern', icon: '⫼', label: tt.ftPattern, title: sketchRibbonFullTitle(lang, 'ft-pattern-linear', tt.ftPattern), action: () => {},
      sub: [
    ...
    { id: 'ft-mirror', icon: '⬌', label: tt.ftMirror, title: sketchRibbonFullTitle(lang, 'ft-mirror', tt.ftMirror), action: () => onAddFeature('mirror') },
  ...
  const evaluateTools: (ToolBtn | 'sep')[] = [
    ...
    { id: 'ev-buckling', icon: '🏛️', label: tt.evBuckling, action: () => onAnalysis?.('bucklingAnalysis'), disabled: !hasResult },

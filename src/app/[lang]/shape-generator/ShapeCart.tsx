  ...
  return (
    <div style={{
      ...
      >
        ...
        <span style={{ fontSize: 14, fontWeight: 800, color: 'var(--nx-text)' }}>
          {t.cart || 'Cart'} ({items.length})
        </span>
        <span style={{ fontSize: 12, color: 'var(--nx-border-strong)', transform: expanded ? 'rotate(180deg)' : 'rotate(0)', transition: 'transform 0.2s' }}>▲</span>
      </button>
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 24px 16px' }}>
        ...
        <div className="nf-scroll" style={{
          ...
          {items.map((item, idx) => (
            <div key={item.id} style={{
              ...
              background: 'var(--nx-panel-2)', borderRadius: 12, border: '1px solid var(--nx-border)',
              ...
              <div style={{ padding: '8px 10px' }}>
                <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--nx-text)', marginBottom: 2, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                  {item.shapeName}
                </div>
                <div style={{ fontSize: 10, color: 'var(--nx-text-2)', lineHeight: 1.3 }}>
                ...
                {item.featureCount > 0 && (
                  <div style={{ fontSize: 9, color: 'var(--nx-accent-2)', fontWeight: 600, marginTop: 2 }}>
              ...
              <div style={{
                ...
                background: 'var(--nx-accent)', color: 'var(--nx-text)', borderRadius: '50%',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, justifyContent: 'flex-end' }}>
          <button onClick={onClear} style={{
            padding: '8px 16px', borderRadius: 10, border: '1px solid var(--nx-border)',
            background: 'var(--nx-panel-2)', color: 'var(--nx-text-2)', fontSize: 12, fontWeight: 600, cursor: 'pointer',
          ...
          <button onClick={onBatchQuote} style={{
            ...
            background: 'linear-gradient(135deg, #1f6feb 0%, var(--nx-accent) 100%)',

...
if (process.env.CI === 'true' && process.env.UPDATE_GOLDENS === '1') {
  throw new Error(
    'UPDATE_GOLDENS=1 must not be set in CI. Regenerate goldens locally, then commit updated __goldens__ files.',
  );
}

  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: 'var(--nx-panel)', color: 'var(--nx-text)', borderRadius: 10,
      ...
      >
            ...
            {(['ISO', 'ANSI'] as HoleStandardSeries[]).map(s => (
              <button
                ...
                style={{
                  ...
                  color: 'var(--nx-text)', border: 'none', borderRadius: 6,
            ...
            {specs.map((s, i) => (
              <button
                ...
                style={{
                  ...
                  color: 'var(--nx-text)', border: 'none', borderRadius: 4,
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8, marginBottom: 12 }}>
          <label style={{ fontSize: 12, color: 'var(--nx-text-2)' }}>
            ...
            <input
              ...
              style={{ width: '100%', padding: '6px 8px', background: 'var(--nx-bg)', color: 'var(--nx-text)', border: '1px solid #374151', borderRadius: 4, marginTop: 4 }}
            />
          </label>
          <label style={{ fontSize: 12, color: 'var(--nx-text-2)' }}>
            Z (mm)
        ...
        {spec && preview && (
          <div style={{
            ...
            padding: 10, fontSize: 12, fontFamily: 'monospace', color: 'var(--nx-text)',
            marginBottom: 14,
          }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8 }}>
          <button
            onClick={onClose}
            style={{ padding: '8px 14px', background: 'var(--nx-border-strong)', color: 'var(--nx-text)', border: 'none', borderRadius: 6, cursor: 'pointer', fontSize: 13 }}
          >
            {t.cancel}
          </button>
          <button
            onClick={handleApply}
            style={{ padding: '8px 14px', background: 'var(--nx-accent)', color: 'var(--nx-text)', border: 'none', borderRadius: 6, cursor: 'pointer', fontSize: 13, fontWeight: 600 }}
          >
            {t.addHole}
          </button>
        </div>

...
const ISSUE_TYPE_TO_PARAM_CANDIDATES: Record<string, string[]> = {
  thin_wall:      ['wall_thickness', 'thickness', 'depth', 'width', 'height', 'shellThickness'],
  uniform_wall:   ['wall_thickness', 'thickness', 'shellThickness'],
  draft_angle:    ['draftAngle', 'draft_angle', 'draft'],
  aspect_ratio:   ['height', 'length', 'width', 'depth'],
  deep_pocket:    ['depth', 'pocketDepth', 'height'],
  sharp_corner:   ['radius', 'filletRadius', 'fillet_radius', 'cornerRadius', 'corner_radius'],
  undercut:       ['depth', 'undercut', 'grooveDepth', 'groove_depth'],
  tool_access:    ['radius', 'groove_width', 'slot_width', 'width', 'depth'],
};

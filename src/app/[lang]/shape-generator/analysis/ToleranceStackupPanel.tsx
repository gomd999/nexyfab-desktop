...
export default function ToleranceStackupPanel({ lang, onClose }: Props) {
          ...
          <>
            ...
            <div style={sectionStyle}>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 11 }}>
                <tbody>
                  <tr>
                    <td style={{ color: C.dim, padding: '2px 0' }}>{t(lang, 'nominal')}</td>
                    ...
                    <>
                      <tr>
                        <td style={{ color: C.dim, padding: '2px 0' }}>
                          {mode === 'worstCase' ? t(lang, 'worstCase') : t(lang, 'rss')} {t(lang, 'wcMax')}
                        </td>
                      ...
                      <tr>
                        <td style={{ color: C.dim, padding: '2px 0' }}>
                          {mode === 'worstCase' ? t(lang, 'worstCase') : t(lang, 'rss')} {t(lang, 'wcMin')}
                        </td>
                  ...
                  {mode === 'monteCarlo' && mcResult && (
                    <>
                      <tr>
                        <td style={{ color: C.dim, padding: '2px 0' }}>{t(lang, 'mean')}</td>
                        <td style={{ textAlign: 'right' }}>{mcResult.mean.toFixed(4)}</td>
                      </tr>
                      <tr>
                        <td style={{ color: C.dim, padding: '2px 0' }}>{t(lang, 'stdDev')}</td>
                        <td style={{ textAlign: 'right' }}>{mcResult.stdDev.toFixed(4)}</td>
                      </tr>
                    </>
                  )}
                  <tr>
                    <td style={{ color: C.dim, padding: '2px 0' }}>{t(lang, 'critical')}</td>
                    <td style={{ textAlign: 'right' }}>
                      {dims.find(d => d.id === stackResult.criticalDimension)?.name || '-'}
                    </td>
                  </tr>
                  <tr>
                    <td style={{ color: C.dim, padding: '2px 0' }}>{t(lang, 'cpk')}</td>
                    <td style={{ textAlign: 'right' }}>
                      <span
                        style={{
            ...
            <div style={sectionStyle}>
              ...
              <div style={{ marginTop: 8 }}>
                {[
                  { label: t(lang, 'nominal'), val: stackResult.nominal, color: C.accent },
                  { label: t(lang, 'worstCase'), val: stackResult.worstCaseMax, color: C.red },
                  { label: t(lang, 'rss'), val: stackResult.rssMax, color: C.yellow },
                ].map(row => (

...
/** Browser download helper — triggers save of the emitted G-code. */
export function downloadGcode(filename: string, code: string, extension: string = 'nc'): void {
  ...
  a.download = name.toLowerCase().endsWith(ext) ? name : name + ext;

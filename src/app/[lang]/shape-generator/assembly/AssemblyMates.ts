...
//
// The iterative Gauss-Seidel solver (AssemblyBody/AssemblyState/Mate types) now
// lives in matesSolver.ts.  Re-export it here so callers can import from either
// location.
//
export type {
...
export type MateType = 'coincident' | 'concentric' | 'distance' | 'angle' | 'parallel' | 'perpendicular' | 'tangent';

...
const RIBBON: Record<Lang, Partial<Record<string, string>>> = {
  en: {
    'sk-line': 'Click to chain segments · Double-click or ESC to finish · Click first point to close',
    'sk-arc': 'Chain arcs · Hover first point to close · ESC to finish',
    'sk-circle': 'Click center, then radius point',
    'sk-rect': 'Click two corners',
    'sk-polygon': 'Click center, then vertex',
    'sk-offset': 'Pick segment, then distance',
    'sk-trim': 'Keep clicking segments to trim · ESC to leave tool',
  ...
  ko: {
    'sk-line': '클릭으로 연속 그리기 · 더블클릭 또는 ESC로 끝내기 · 첫 점 클릭으로 닫기',
    'sk-arc': '연속 호 그리기 · 첫 점 hover로 닫기 · ESC로 끝내기',
    'sk-circle': '중심 클릭 → 반지름 점 클릭',
    'sk-rect': '두 모서리 클릭',
    'sk-polygon': '중심 클릭 → 꼭짓점 클릭',
    'sk-offset': '세그먼트 선택 후 거리',
    'sk-trim': '세그먼트 계속 클릭하여 자르기 · ESC로 도구 나가기',

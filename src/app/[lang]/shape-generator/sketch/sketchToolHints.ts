...
const RIBBON: Record<Lang, Partial<Record<string, string>>> = {
  en: {
    ...
    // ── Feature tools (3D) ──
    'ft-extrude': 'Add depth to a sketch profile · directional ± per face',
    'ft-extcut': 'Subtract an extruded sketch from the body',
    'ft-revolve': 'Revolve a sketch around an axis (360° default)',
    'ft-sweep': 'Sweep a profile along a path · second sketch required',
    'ft-loft': 'Blend ≥2 profile sketches into a smooth body',
    'ft-fillet': 'Round selected edges by radius',
    'ft-chamfer': 'Add flat bevel to selected edges',
    'ft-shell': 'Hollow the body to a wall thickness',
    'ft-draft': 'Slant faces for mold/casting release',
    'ft-hole': 'Hole wizard: thread, counterbore, countersink presets',
    'ft-thread': 'Cosmetic threaded representation on a cylinder',
    'ft-pattern-linear': 'Repeat a feature along an axis',
    'ft-pattern-circular': 'Repeat a feature around a center',
    'ft-mirror': 'Mirror a feature across a plane',
  },
  ko: {
    ...
    // ── 피처 도구 (3D) ──
    'ft-extrude': '스케치 프로파일에 깊이 추가 · 면별 ± 방향',
    'ft-extcut': '돌출된 스케치를 본체에서 차감',
    'ft-revolve': '축 기준 회전 (기본 360°)',
    'ft-sweep': '경로를 따라 프로파일 스윕 · 보조 스케치 필요',
    'ft-loft': '2개 이상 프로파일을 부드럽게 연결',
    'ft-fillet': '선택 엣지를 반지름으로 둥글게',
    'ft-chamfer': '선택 엣지에 평평한 모따기',
    'ft-shell': '본체를 벽 두께로 비우기',
    'ft-draft': '금형 이형을 위해 면 기울이기',
    'ft-hole': '홀 위저드: 나사·카운터보어·카운터싱크 프리셋',
    'ft-thread': '원기둥 표면에 나사 표현',
    'ft-pattern-linear': '피처를 축 따라 반복',
    'ft-pattern-circular': '피처를 중심 주위로 반복',
    'ft-mirror': '평면을 기준으로 피처 미러링',
  },
  ja: {

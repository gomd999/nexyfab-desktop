...
const CORE: ReadonlySet<string> = new Set([
  ...
  // Geometric representation contexts + items
...
const PMI_PREFIXES: readonly string[] = [
  ...
  'CALLOUT',
  'ANNOTATION_',
  // AP242 PMI measure entities. Note: LENGTH_MEASURE_WITH_UNIT starts
  // with 'LENGTH_', not 'MEASURE_', so it stays in UNITS (priority
  // order is BIM > TESSELLATED > PMI > CORE > UNITS > STYLE).

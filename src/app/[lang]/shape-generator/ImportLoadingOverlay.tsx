...
export default function ImportLoadingOverlay({ isImporting, loadingFileText }: ImportLoadingOverlayProps) {
  ...
  return (
    <div style={{
      ...
      background: 'var(--nx-glass-strong)', backdropFilter: 'blur(6px)',
      display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ textAlign: 'center', color: 'var(--nx-text)' }}>
        <div style={{ width: 40, height: 40, border: '3px solid var(--nx-border)', borderTopColor: 'var(--nx-accent)', borderRadius: '50%', animation: 'spin 0.8s linear infinite', margin: '0 auto 16px' }} />

...
export const PLAN_LIMITS: Record<UserPlan, PlanLimits> = {
  ...
  pro: {
    ...
    feaAnalysis: true,
    costEstimation: true,
    // W5-H: sat/iges/ifc 는 기존 STEP/DXF 와 동급(pro 이상) — 별도 정책 신설 없음.
    exportFormats: ['stl', 'step', 'obj', 'dxf', 'gltf', 'ply', 'sat', 'iges', 'ifc'],
    cloudSave: true,
    collaboration: false,
    rfq: true,
    ipShareLink: true,
  ...
  team: {
    ...
    feaAnalysis: true,
    costEstimation: true,
    exportFormats: ['stl', 'step', 'obj', 'dxf', 'gltf', 'ply', 'sat', 'iges', 'ifc', 'rhino', 'grasshopper'],
    cloudSave: true,
    collaboration: true,
    rfq: true,
    ipShareLink: true,

...
export async function parseSTEP(buffer: ArrayBuffer): Promise<THREE.BufferGeometry> {
...
export async function importFile(file: File): Promise<{
  ...
  return { geometry, format: ext.toUpperCase(), filename: file.name };
}

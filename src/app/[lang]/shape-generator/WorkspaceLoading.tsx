        ...
        <div style={{ position: 'relative', width: 64, height: 64, marginBottom: 24 }}>
          ...
          <div
            style={{
              ...
              right: 0,
              bottom: 0,
              border: '4px solid var(--nx-accent-2)',
              borderRadius: '50%',
              borderTopColor: 'transparent',
              animation: 'nf-wl-spin-app 1s linear infinite',
            }}
          />
          <svg style={{ position: 'absolute', top: 16, left: 16 }} width={32} height={32} viewBox="0 0 24 24" fill="none" stroke="var(--nx-accent-2)" strokeWidth={2}>
    ...
    >
      <div
        style={{
          width: '44px',
          height: '44px',
          border: '3px solid var(--nx-border-strong)',

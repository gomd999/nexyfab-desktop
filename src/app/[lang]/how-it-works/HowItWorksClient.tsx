    ...
    return (
        <main id="Nexyfab-how-it-works">
            ...
            <section className="hat-how-hero">
                <p className="hat-kicker reveal">{richText(d.howKicker)}</p>
                <h1 className="hat-title reveal">{richText(t.heroTitle)}</h1>
                <p className="hat-sub reveal">{richText(t.heroSub)}</p>
            </section>
            ...
            <section className="hat-inner">
                <div className="hat-roadmap">
                    ...
                    <div id="step-1" className="hat-step-card reveal" style={{ scrollMarginTop: '100px' }}>
                        ...
                        <p className="hat-step-desc">{richText(t.step1Desc)}</p>
                    </div>
                    ...
                    <div id="step-2" className="hat-step-card reveal" style={{ transitionDelay: '0.1s', scrollMarginTop: '100px' }}>
                        ...
                        <p className="hat-step-desc">{richText(t.step2Desc)}</p>
                    </div>
                    ...
                    <div id="step-3" className="hat-step-card reveal" style={{ transitionDelay: '0.2s', scrollMarginTop: '100px' }}>
                        ...
                        <p className="hat-step-desc">{richText(t.step3Desc)}</p>
                    </div>
                </div>
            </section>
            ...
            <section className="reveal" id="Nexyfab-how-cta" style={{
                ...
                {/* CTA */}
                <h2 style={{ fontSize: '26px', fontWeight: 700, marginBottom: '14px', color: '#1A1F36' }}>{richText(d.ctaTitle)}</h2>
                <p style={{ fontSize: '15px', color: '#64748b', marginBottom: '32px', lineHeight: 1.7 }}>{richText(d.ctaSub)}</p>

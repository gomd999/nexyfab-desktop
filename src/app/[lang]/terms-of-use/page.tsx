...
const dict = {
    ko: {
        ...
        a9i5: '구독 결제일로부터 7일 이내에 서비스를 이용하지 않은 경우, 이메일(nexyfab@nexysys.com)을 통해 전액 환불을 요청할 수 있습니다. 이후에는 환불이 제공되지 않습니다.',
    ...
    en: {
        ...
        a9i5: 'If the service has not been used within 7 days of the subscription payment date, a full refund may be requested via email (nexyfab@nexysys.com). Refunds are not available thereafter.',
    ...
    ja: {
        ...
        a9i5: 'サブスクリプション決済日から7日以内にサービスを利用していない場合、メール（nexyfab@nexysys.com）にて全額返金を申請できます。それ以降は返金対応いたしかねます。',
    ...
    zh: {
        ...
        a9i5: '若订阅付款日起7天内未使用服务，可通过电子邮件（nexyfab@nexysys.com）申请全额退款。此后将不提供退款。',

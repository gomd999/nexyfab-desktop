...
const dict = {
    ko: {
        ...
        a7i2: '본 서비스와 관련하여 발생한 분쟁에 대해서는 회사 소재지 관할 법원을 전속 관할 법원으로 합니다.',
    ...
    return (
        <main style={{ minHeight: '100vh', backgroundColor: '#fff', paddingBottom: '80px' }}>
            ...
            <section style={{ maxWidth: '800px', margin: '0 auto', padding: '0 20px', lineHeight: 1.8, color: '#333', fontSize: '16px', display: 'flex', flexDirection: 'column', gap: '32px' }}>
                ...
                {'a9Title' in t && (
                <div>
                    <h2 style={{ fontSize: '22px', fontWeight: 800, marginBottom: '12px', color: '#111' }}>{(t as any).a9Title}</h2>
                    <p style={{ marginBottom: '10px' }}>{(t as any).a9Desc}</p>
                    <ul style={{ paddingLeft: '20px', listStyleType: 'disc', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        <li>{(t as any).a9i1}</li>
                        <li>{(t as any).a9i2}</li>
                        <li>{(t as any).a9i3}</li>
                ...
                {'a8Title' in t && (
                <div>
                    <h2 style={{ fontSize: '22px', fontWeight: 800, marginBottom: '12px', color: '#111' }}>{(t as any).a8Title}</h2>

                    <div style={{ marginBottom: '20px' }}>
                        <h3 style={{ fontSize: '18px', fontWeight: 700, marginBottom: '10px', color: '#222' }}>{(t as any).a8s1Title}</h3>
                        <ul style={{ paddingLeft: '20px', listStyleType: 'disc', display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '10px' }}>
                            <li>{(t as any).a8s1b1}</li>
                            <li>{(t as any).a8s1b2}</li>
                            <li>{(t as any).a8s1b3}</li>
                        </ul>
                        <p style={{ marginBottom: '8px' }}>{(t as any).a8s1Desc}</p>
                        <p style={{ fontWeight: 700, marginBottom: '4px' }}>{(t as any).a8s1TableTitle}</p>
                        <p style={{ color: '#555', fontSize: '15px' }}>{(t as any).a8s1Penalty}</p>
                    </div>

                    <div>
                        <h3 style={{ fontSize: '18px', fontWeight: 700, marginBottom: '10px', color: '#222' }}>{(t as any).a8s2Title}</h3>
                        <ul style={{ paddingLeft: '20px', listStyleType: 'disc', display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '10px' }}>
                            <li>{(t as any).a8s2b1}</li>
                        </ul>
                        <p style={{ marginBottom: '8px' }}>{(t as any).a8s2Desc}</p>
                        <p style={{ color: '#555', fontSize: '15px' }}>{(t as any).a8s2Penalty}</p>
                    </div>
                </div>
                )}

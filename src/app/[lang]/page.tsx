    ...
    <main dir={lang === 'ar' ? 'rtl' : 'ltr'}>
        ...
        <div className="nf-onboarding-overlay" role="dialog" aria-modal="true" aria-labelledby="onboarding-title">
          <div className="nf-onboarding-modal">
            ...
            <p style={{ color: '#8b949e', fontSize: 13, margin: '0 0 28px' }}>
              {(t as any).onboardingSub}
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {[
                { icon: '🎨', label: (t as any).onboardingPath1, desc: (t as any).onboardingPath1Desc, action: () => { dismissOnboarding(); window.location.href = `/${langCode}/shape-generator/`; } },
                { icon: '🏭', label: (t as any).onboardingPath2, desc: (t as any).onboardingPath2Desc, action: () => { dismissOnboarding(); window.location.href = `/${langCode}/project-inquiry/`; } },
                { icon: '🔍', label: (t as any).onboardingPath3, desc: (t as any).onboardingPath3Desc, action: () => { dismissOnboarding(); window.location.href = `/${langCode}/factories/`; } },
              ].map((path, i) => (
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '1100px', width: '100%', textAlign: 'center' }}>
          ...
          <p style={{
            ...
            maxWidth: '720px', margin: '0 auto 40px', whiteSpace: 'pre-line',
          }}>
          ...
          <div style={{ display: 'flex', gap: '14px', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '24px' }}>
            <a href={`/${langCode}/shape-generator/`} style={{
            ...
            <a href={`/${langCode}/project-inquiry/`} style={{
              padding: '14px 36px', borderRadius: '14px', fontSize: '16px', fontWeight: 800,
          ...
          <div style={{ margin: '0 auto 50px', textAlign: 'center' }}>
            <a href={`/${langCode}/factories/`} style={{
      ...
      <section id="Nexyfab-why-v3">
        ...
        <div className="hat-wrap">
          ...
          <div className="hat-cta-center reveal">
            ...
            <a className="hat-cta-btn" href={`/${langCode}/project-inquiry/`}>{t.whyCtaBtn}</a>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#f8fafc', padding: '90px 24px' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginTop: '40px' }} className="reveal">
            <a href={`/${langCode}/shape-generator/`} style={{ display: 'inline-block', padding: '12px 28px', border: '2px solid #3b82f6', color: '#1d4ed8', borderRadius: '12px', fontWeight: 700, fontSize: '14px', textDecoration: 'none', transition: 'all 0.2s', background: 'transparent' }}
      ...
      <section id="Nexyfab-usecases" className="hat-usecases">
        ...
        <div className="hat-wrap">
          <header className="hat-head reveal">
            ...
            <p className="hat-sub" dangerouslySetInnerHTML={{ __html: t.caseSub }} />
          </header>
              ...
              <article key={i} className="hat-case reveal" role="listitem">
                <div className="hat-case-top">
                  ...
                  <div>
                    ...
                    <p className="hat-case-desc" dangerouslySetInnerHTML={{ __html: c.desc }} />
                  </div>
                </div>
          ...
          <div className="hat-note reveal">
            ...
            <div className="hat-note-sub" dangerouslySetInnerHTML={{ __html: t.caseNoteSub }} />
          </div>
        </div>
      </section>
      ...
      <section id="Nexyfab-final-cta" className="hat-final-cta soft">
        ...
        <div className="hat-wrap">
          ...
          <p className="hat-sub" dangerouslySetInnerHTML={{ __html: t.ctaSub }} />
          <div className="hat-actions">
            <a className="hat-btn-primary" href={`/${langCode}/shape-generator/`}>{t.platformCta1}</a>
            <a className="hat-btn-primary" href={`/${langCode}/project-inquiry/`}>{t.ctaBtn1}</a>
            <a className="hat-btn-secondary" href={`/${langCode}/factories/`}>{t.ctaBtn2}</a>
          </div>
        </div>
      </section>
    </main>

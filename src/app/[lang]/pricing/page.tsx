                ...
                {activeTab === '3d' && (
                    <>
                        ...
                        <div style={{
                            ...
                            <a href={`/${rawLang}/shape-generator/`} style={{
                    ...
                    <>
                        ...
                        <div className="nf-pricing-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px', marginBottom: '40px' }}>
                            ...
                            <div style={card}>
                                ...
                                <a href="/login" style={{ display: 'block', textAlign: 'center', padding: '14px', borderRadius: '12px', background: '#f3f4f6', color: '#111827', fontWeight: 800, fontSize: '14px', textDecoration: 'none', transition: '0.2s' }}
                            ...
                            <div style={cardHighlight}>
                                ...
                                <a href="/login" style={{ display: 'block', textAlign: 'center', padding: '14px', borderRadius: '12px', background: blue, color: '#fff', fontWeight: 800, fontSize: '14px', textDecoration: 'none' }}>
                                    {t.ctaPremium}
                                </a>
                            </div>
                        </div>

    ...
    <ToastProvider>
      <div className="min-h-screen bg-gray-50">
        <nav className="bg-white border-b px-4 py-2.5 flex items-center gap-1 flex-wrap">
          <a href="/admin" className="font-bold text-base text-gray-900 mr-3 hover:text-blue-600 transition-colors shrink-0">
          ...
          <div className="ml-auto flex items-center gap-2 shrink-0">
            ...
            <a href="/partner/dashboard" className="text-xs text-gray-400 hover:text-gray-600 px-2 py-1 rounded-lg hover:bg-gray-100 transition-colors">파트너 포털</a>
            <a href="/" className="text-xs text-gray-400 hover:text-gray-600 px-2 py-1 rounded-lg hover:bg-gray-100 transition-colors">← 사이트로</a>
          </div>
        </nav>

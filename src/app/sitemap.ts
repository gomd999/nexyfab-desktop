...
const PAGES = [
    ...
    { path: '/shape-generator/sketch', priority: 0.9, changeFrequency: 'weekly' },
    ...
    { path: '/nexyfab/developers', priority: 0.6, changeFrequency: 'monthly' },

...
export async function GET(req: NextRequest) {
  ...
  if (format === 'csv') {
    const csv = XLSX.utils.sheet_to_csv(XLSX.utils.json_to_sheet(contractRows));
  ...
  XLSX.utils.book_append_sheet(wb, XLSX.utils.json_to_sheet(contractRows), '계약 목록');
  XLSX.utils.book_append_sheet(wb, XLSX.utils.json_to_sheet(rfqRows), 'RFQ 목록');

...
- washer: outerDia, boreDia, thickness   (평와셔 — 볼트홀이 필요한 원판은 flange가 아니라 이걸 써라. 볼트서클이 있는 flange와 헷갈리지 말 것)
...
어휘 16종: plate_with_holes / stepped_plate / l_bracket / flange / bent_sheet / tube / rect_tube / box / cylinder / gusset / base_plate / spur_gear / hex_bolt / sheet_profile / wall_with_openings / washer.
${TYPE_SPEC}

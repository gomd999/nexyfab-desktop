...
export async function GET(req: NextRequest) {
  ...
  const assignedRfqs = factory
    ...
    : [] as { id: string; shape_name: string; material_id: string; quantity: number; status: string; created_at: number; assigned_at: number | null; dfm_score: number | null; volume_cm3: number; note: string | null; }[];

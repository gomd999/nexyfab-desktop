...
export function buildComplexProductScopeAssessment(root) {
  ...
  return {
    ...
    internalRobot: {
      ...
      revision: robotProduct.revision ?? null,
      driveTopology: robotProduct.driveTopology ?? null,
      ...
      intendedContacts: robotAssembly.releaseContactCount ?? null,
      preciseInterferences: robotAssembly.flaggedInterferences ?? null,
      exploratoryMotionFrames: robot.value.motionStudy?.frameCount ?? null,
      exploratoryCheckedMotionFrames: robot.value.motionStudy?.checkedFrames ?? null,
      exploratoryMotionAxes: robot.value.motionStudy?.axisCount ?? null,
      exploratoryCollisionFrames: robot.value.motionStudy?.collisionFrameCount ?? null,
      coordinatedMotionFrames: robot.value.coordinatedMotionStudy?.frameCount ?? null,
      coordinatedCheckedMotionFrames: robot.value.coordinatedMotionStudy?.checkedFrames ?? null,
      coordinatedCollisionFrames: robot.value.coordinatedMotionStudy?.collisionFrameCount ?? null,
      ...
      requiredNextEvidence: [
        ...
        'signed_full_motion_reverification_after_catalog_integration',

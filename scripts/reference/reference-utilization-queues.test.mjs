...
const artifact = (relativePath, lane) => ({ relativePath, lineageId: 'robot', extension: 'step', sizeBytes: 10, sha256: 'a'.repeat(64), automatedCheck: 'probe', fidelity: 'bounded', roles: ['test'], lane, commercialScoreEligible: false, trainingEligible: false });
const manifest = {
  ...
  summary: { assignedFiles: 5, securityExcludedFiles: 0, discoveredFiles: 5, byLane: { exact_exchange_regression: 1, native_semantics_review_queue: 1, visual_reference: 1, derived_ir_reuse: 1, catalog_only: 1 } },
  lineages: [{ lineageId: 'robot-5-dof-1', files: 5, bytes: 50, lanes: [], formats: [] }],

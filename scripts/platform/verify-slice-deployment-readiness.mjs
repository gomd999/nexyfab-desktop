...
const REQUIRED_RUNTIME_BINDINGS = {
  ...
  'precision-cad': ['EXACT_KERNEL_URL', 'EXACT_KERNEL_AUTH_TOKEN', 'JOB_CONTROL_URL', 'JOB_CONTROL_AUTH_TOKEN', 'EXACT_KERNEL_IDENTITY', 'NEXYFAB_BUILD_ID'],
  'ai-design': ['ANALYSIS_URL', 'ANALYSIS_AUTH_TOKEN', 'AI_LIVE_ENABLED', 'NEXYFAB_BUILD_ID'],
};

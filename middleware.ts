 ...
 * x-admin-secret header to match ADMIN_SECRET, OR the user's plan to be
 * 'enterprise'.  Partner routes (/api/partner/**) are intentionally excluded
 * from this stricter check — they only need a valid JWT.
 */
